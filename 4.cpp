# define _CRT_SECURE_NO_WARNINGS//编译器不建议使用scanf等函数认为其不安全，定义此宏可禁用错误和警告提示
#include<stdio.h>
#include<string.h>
#include<stdlib.h>
#include<windows.h>
...
void insert();			//插入数据
void deleted();			//删除数据函数
void find(stu *p2);		//通过姓名查找数据
void update(stu *p2);	//通过姓名查找并修改数据
